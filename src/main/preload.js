...
contextBridge.exposeInMainWorld('api', {
  ...
  subtasks: {
    create: (todoId, title) => ipcRenderer.invoke('subtasks:create', todoId, title),
    update: (id, updates) => ipcRenderer.invoke('subtasks:update', id, updates),
    delete: (id) => ipcRenderer.invoke('subtasks:delete', id),
    reorder: (todoId, subtaskIds) => ipcRenderer.invoke('subtasks:reorder', todoId, subtaskIds),
  },
  ...
  streaks: {
    ...
    recordCompletion: (date) => ipcRenderer.invoke('streaks:recordCompletion', date),
  },
  ...
  files: {
    ...
    setWorkingDirectory: (path) => ipcRenderer.invoke('files:setWorkingDirectory', path),
  },
